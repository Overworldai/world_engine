...
```
# Optional: install dependencies used by examples (OpenCV, pytest, benchmark plugin)
pip install --upgrade --ignore-installed "world_engine[examples] @ git+https://github.com/Overworldai/world_engine.git"
```
