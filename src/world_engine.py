...
class WorldEngine:
    ...
    def gen_frame_pipelined(self, ctrl: CtrlInput = None):
        """Pipelined generation. Base class falls back to synchronous gen_frame.
        Subclasses (e.g. MLXWorldEngine) override with async decode."""
        return self.gen_frame(ctrl, return_img=True)

    def flush_pipeline(self):
        """Drain any pending pipelined decode. No-op in base class."""
        return None
